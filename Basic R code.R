...
a<-1L # to define integer: 'L' needs to be added at the end
a
class(a)
x<-1.2L
x
...
x
y<-letters[4:6] # sequesnce of letters in smalls
y
y[2]
...
DF
DF2<-data.frame(Id=c(5,'N',7,8),name=c('A',2,'V','p'),marks=c(7,9.5,8.5,7.5))
DF2
